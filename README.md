...
:-------------------------:|:-------------------------:
![Random Agent](results/Tennis_Random_Brain.gif)  |  ![Trained Agent](results/Tennis_Trained_Brain.gif)
...
##### Clone repository
```bash
git clone git@github.com:joselaral/p3-collab-compet-solution-drl.git
```

##### Install using Miniconda3
``` bash
cd path/to/p3-collab-compet-solution-drl.git
